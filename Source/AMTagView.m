...
#define kDefaultFont			[UIFont fontWithName:@"HelveticaNeue-Light" size:13.0f]//[UIFont systemFontOfSize:13]
#define kDefaultTagColor		[UIColor whiteColor]
#define kDefaultInnerTagColor	[UIColor colorWithWhite:1 alpha:0.3]
#define kDefaultImagePadding	0
